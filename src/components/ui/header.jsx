        ...
        <div className={`flex top-0 justify-between ${FixedMenu && 'fixed shadow-md'} left-0 right-0 w-full z-50 bg-white items-center py-4 px-2 lg:px-8 md:px-8 `}>
            ...
            <div className='flex gap-6 items-center '>
                <ul className='hidden lg:flex md:flex  gap-6 relative'>
                    <li>
                        <NavLink to='/' className={PageActive}>
                            <h2 className='text-sm'>Home</h2>
                        </NavLink>
                    </li>
                    <li> 
                        <NavLink to='/about' className={PageActive}>
                            <h2 className='text-sm'>About</h2>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to='/service' className={PageActive}>
                            <h2 className='text-sm'>Services</h2>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to='/contact' className={PageActive}>
                            <h2 className='text-sm'>Contact</h2>
                        </NavLink>
                    </li>
                </ul>
                <div>
                    <Button className="hidden lg:flex md:flex rounded-full bg-blue-700">
                        <h3 className='text-sm'>Book Now</h3>
                    </Button>
                </div>
