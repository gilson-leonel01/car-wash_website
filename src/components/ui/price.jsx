    ...
    <React.Fragment>
        <div className={`w-60  bg-zinc-500/10 rounded-md   ${Card  ? 'scale-110 shadow-2xl shadow-zinc-500/50 border-red-600 border-solid border-[1px] ': "scale-105"}`}>
            ...
            <div className='w-full p-4'>
                <Button className={`w-full ${ Card ? 'bg-red-500 transition-all ease-linear duration-300 hover:bg-red-700 rounded-full':'bg-transparent rounded-full border-blue-500  transition-all ease-linear duration-300 hover:bg-blue-700'}`} 
